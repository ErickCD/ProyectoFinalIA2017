...
%Análisis Pregunta2
%-------------------------------------------
bR1(R1):- espregunta('¿Golpea con el lápiz?', R1),R1 = 'siempre', cont_R1.
bR1(R1):- espregunta('¿Golpea con el lápiz?', R1),R1 = 'generalmente', cont_R2.
bR1(R1):- espregunta('¿Golpea con el lápiz?', R1),R1 = 'nunca', cont_R3.
